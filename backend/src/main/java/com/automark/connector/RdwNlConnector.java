...
import com.automark.domain.*; import com.fasterxml.jackson.databind.*; import org.springframework.beans.factory.annotation.Value; import org.springframework.stereotype.Component; import org.springframework.web.client.RestClient; import java.util.*;
@Component public class RdwNlConnector implements VehicleSourceConnector {
 private final RestClient client; public RdwNlConnector(RestClient.Builder b,@Value("${automark.rdw.base-url}") String url){client=b.baseUrl(url).build();}
