...
import com.taxcalculator.service.*; import jakarta.validation.Valid; import org.springframework.http.*; import org.springframework.web.bind.annotation.*; import java.util.*;
@RestController @RequestMapping("/api") @CrossOrigin(origins="${TAXCALCULATOR_CORS_ORIGIN:http://localhost:5173}") public class LookupController {
